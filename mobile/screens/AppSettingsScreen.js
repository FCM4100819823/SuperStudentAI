...
const AppSettingsScreen = ({ navigation }) => {
      ...
      if (docSnap.exists()) {
        ...
        setSettings((prevSettings) => ({
          ...
          notificationsEnabled:
            userData.appSettings?.notificationsEnabled !== undefined
              ? userData.appSettings.notificationsEnabled
              : true,
          darkMode:
            userData.appSettings?.darkMode !== undefined
              ? userData.appSettings.darkMode
              : false,
          dataSync:
            userData.appSettings?.dataSync !== undefined
              ? userData.appSettings.dataSync
              : true,
          language: userData.appSettings?.language || 'English',
          aiPersonalization:
            userData.appSettings?.aiPersonalization !== undefined
              ? userData.appSettings.aiPersonalization
              : true,
  ...
  const handleShareApp = async () => {
    try {
      await Share.share({
        message:
          'Check out SuperStudentAI! Your personal AI study companion. Download now: [App Store Link] or [Play Store Link]',
  ...
  const renderSettingItem = ({
    ...
    <TouchableOpacity
      ...
      style={[
        ...
        isLastInSection && styles.settingItemContainerLast,
      ]}
    >
      ...
      {type === 'switch' && (
        <Switch
          trackColor={{
            false: STATIC_COLORS.border,
            true: STATIC_COLORS.secondary,
          }}
          thumbColor={
            value ? STATIC_COLORS.primaryLight : STATIC_COLORS.surface
          }
  ...
  if (loading) {
    return (
      <SafeAreaView style={styles.flexOne}>
        {' '}
        {/* Ensure SafeAreaView wraps the loading state */}
    ...
    <SafeAreaView style={styles.flexOne}>
      ...
      >
        ...
        >
          ...
          />
          <Text
            style={[styles.headerTitle, { color: STATIC_COLORS.textOnPrimary }]}
          >
            Settings
          </Text>
          <Text
          ...
          >
            Tailor SuperStudentAI to your needs
          </Text>
        </LinearGradient>
        ...
        <View style={styles.sectionContainer}>
          ...
          {renderSettingItem({
            ...
            iconName: settings.notificationsEnabled
              ? 'notifications'
          ...
          {renderSettingItem({
            ...
            onPress: () =>
              handleNavigateToFeature('Study Reminders Customization'), // Placeholder
          })}
          {renderSettingItem({
            ...
            onValueChange: (val) =>
              handleSettingChange('aiPersonalization', val),
        ...
        <View style={styles.sectionContainer}>
          ...
          {renderSettingItem({
            ...
            type: 'navigation',
            onPress: () =>
              Linking.openURL('YOUR_FAQ_URL').catch((err) =>
        ...
        <View style={styles.sectionContainer}>
          ...
          {renderSettingItem({
            ...
            type: 'navigation',
            onPress: () =>
              Linking.openURL('YOUR_PRIVACY_POLICY_URL').catch((err) =>
          ...
          {renderSettingItem({
            ...
            type: 'navigation',
            onPress: () =>
              Linking.openURL('YOUR_TERMS_OF_SERVICE_URL').catch((err) =>
