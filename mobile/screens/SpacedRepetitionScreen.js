...
const SpacedRepetitionScreen = ({ navigation }) => {
  ...
  const handleReviewAction = async (itemId, quality) => {
    ...
    try {
      ...
      await axios.put(
        `${SRS_ENDPOINT}/items/${itemId}/review`,
        { quality },
        { headers: { Authorization: `Bearer ${token}` } },
      );
      ...
      if (currentItemIndex >= dueItems.length - 1) {
        Alert.alert(
          'Review Complete',
          "You've reviewed all due items for now!",
        );
  ...
  const currentItem =
    dueItems.length > 0 && currentItemIndex < dueItems.length
      ...
      <View style={styles.container}>
        ...
        <View style={styles.centered}>
          ...
          <Text style={styles.subEmptyMessage}>
            Check back later or add new items to your review queue.
          </Text>
          <TouchableOpacity
            style={styles.primaryButton}
            onPress={fetchDueItems}
          >
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('AddSpacedRepetitionItem')}
          >
    ...
    <View style={styles.container}>
      <View style={styles.headerBar}>
        ...
        <Text style={styles.headerTitle}>
          Review Session ({currentItemIndex + 1}/{dueItems.length})
        </Text>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.card}>
          ...
          <Text style={styles.cardContentQuestion}>
          ...
          {showAnswer && (
            <View style={styles.answerSection}>
              ...
              <Text style={styles.cardContentAnswer}>
                {currentItem.answerContent || 'No answer provided.'}
              </Text>
            </View>
          )}
            ...
            <View style={styles.feedbackButtons}>
              {[
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    handleReviewAction(currentItem._id, feedback.quality)
                  }
                >
                  <FontAwesome5
                    name={feedback.icon}
        ...
        {feedbackGiven && (
          <View style={styles.feedbackGivenMessage}>
            ...
            <Text style={styles.feedbackGivenText}>
              Feedback recorded. Moving to next card shortly...
            </Text>
          </View>
        )}
      </ScrollView>
