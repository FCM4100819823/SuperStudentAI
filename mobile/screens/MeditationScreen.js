...
const MEDITATION_SESSIONS = [
  {
    ...
    description:
      'Begin your day with calm and focus. This short meditation helps set a positive tone.',
    duration: 5 * 60, // seconds
    audioUrl: 'https://example.com/royalty-free-music/mindful-start-5min.mp3', // Replace with actual URL
    image: {
      uri: 'https://images.pexels.com/photos/3861958/pexels-photo-3861958.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
  ...
  },
  {
    ...
    description:
      'Release tension and find peace with this guided session for stress reduction.',
    duration: 10 * 60,
    audioUrl: 'https://example.com/royalty-free-music/stress-relief-10min.mp3', // Replace with actual URL
    image: {
      uri: 'https://images.pexels.com/photos/40568/meditation-lotus-yoga-relax-40568.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
    }, // Replace with actual image URI
  },
  {
    id: '3',
    ...
    description:
      'Prepare for a restful night with this calming meditation designed to promote deep sleep.',
    duration: 15 * 60,
    audioUrl: 'https://example.com/royalty-free-music/deep-sleep-15min.mp3', // Replace with actual URL
    image: {
      uri: 'https://images.pexels.com/photos/2247179/pexels-photo-2247179.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
    }, // Replace with actual image URI
  },
  {
    id: '4',
    ...
    description:
      'Enhance your concentration for study or work with this guided meditation.',
    duration: 7 * 60,
    audioUrl: 'https://example.com/royalty-free-music/focus-boost-7min.mp3', // Replace with actual URL
    image: {
      uri: 'https://images.pexels.com/photos/3771089/pexels-photo-3771089.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
    }, // Replace with actual image URI
  },
  {
    id: '5',
    ...
    duration: 12 * 60,
    audioUrl:
      'https://example.com/royalty-free-music/walking-meditation-12min.mp3', // Replace with actual URL
    image: {
      uri: 'https://images.pexels.com/photos/1556706/pexels-photo-1556706.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260',
    }, // Replace with actual image URI
  },
];
  ...
  const handleSeek = async (value) => {
    ...
    try {
      await soundRef.current.setPositionAsync(
        value * playbackStatus.durationMillis,
      );
    } catch (e) {
        ...
        <View style={styles.playerContainer}>
          ...
          <View style={styles.controls}>
            <TouchableOpacity
              ...
              onPress={() => soundRef.current.replayAsync({ shouldPlay: true })}
              disabled={!playbackStatus.isLoaded}
            >
              {' '}
              {/* Example: Replay from start */}
              <Ionicons
                name="play-skip-back-outline"
                size={30}
                color={!playbackStatus.isLoaded ? colors.grey : colors.primary}
              />
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.controlButton}
